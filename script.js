...
// Default Arrays
var defaultArrayOne = ['static/img/img_01.png', 'static/img/img_02.png', 'static/img/img_03.png', 'static/img/img_04.png', 'static/img/img_05.png', 'static/img/img_06.png', 'static/img/img_07.png', 'static/img/img_08.png'];
var defaultArrayTwo = ['static/img/img_09.png', 'static/img/img_10.png', 'static/img/img_11.png', 'static/img/img_12.png', 'static/img/img_13.png', 'static/img/img_14.png', 'static/img/img_15.png', 'static/img/img_16.png'];
...
if (buttonTwo.addEventListener) {
	buttonTwo.addEventListener("click", function() {
		...
		setTimeout(function () {
			...
			// remove first 8 items from each array
			defaultArrayOne.splice(0, 8); //splice(change the content of the array)
			defaultArrayTwo.splice(0, 8);
